...
#docker run -d yyqq188/qcc_asiainfo_cookie
...
#
#docker run -e LANG=C.UTF-8 -d  yyqq188/qcc_asiainfo_pagelist_spider
#注意启动时加LANG
...
#docker run -e LANG=C.UTF-8 -d  yyqq188/qcc_asiainfo_detail_spider
#注意启动时加LANG
#后期需要修改settings文件中的proxy服务器
